              ...
              <DialogPanel class="flex w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                ...
                <form @submit.prevent="submitForm" class="mx-auto w-full">
                  ...
                  <div class="flex justify-center w-full">
                      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5">Agregar</button>
                  </div>
...
import { addProducts } from '@/backend/products';
